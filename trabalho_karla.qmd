...
No dia 18 de janeiro de 2021 foi iniciada a Campanha Nacional de Vacinação contra a COVID-19 no Brasil [@ministériodasaúde.secretariaextraordináriadeenfrentamentoàcovid-192022]. 
...
- Analisar a distribuição espacial da cobertura vacinal para a primeira e segunda doses da vacina contra a COVID-19 entre as unidades da federação no Brasil.

- Analisar a distribuição espacial da cobertura vacinal para a primeira e segunda doses da vacina contra a COVID-19 entre os municípios do Rio de Janeiro.

## **Métodos**

Os dados foram obtidos na página do Painel de Cobertura Vacinal COVID do Ministério da Saúde [@coberturavacinalms]. Foram utilizados os dados de cobertura por residência, que consideram as informações do endereço cadastrado no Cartão Nacional de Saúde (CNS) do cidadão [@SEI/MS0036724379].
...
Na etapa seguinte, buscou-se identificar a existência de estrutura de correlação espacial entre as áreas. Foi utilizada matriz de vizinhança por contiguidade, transformada em seguida em uma matriz de pesos utilizada para para estimar o Índice de Moran que indica o grau de associação espacial para a cobertura vacinal.
